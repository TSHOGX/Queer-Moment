...
const Home: NextPage = () => {
  ...
  return (
    <main>
      ...
      <div ref={showFormDivRef} className={btnYou ? "z-20" : " "}>
      ...
      {showPost && !btnWe && !btnYou && (
        <motion.div
          ...
          ref={showPostDivRef}
        >
          <button onClick={handleClickBtnL}>
            <img
          ...
          <button onClick={handleClickBtnR}>
            <img
          ...
          <div className=" showpostcontent ">{newPostContent}</div>
